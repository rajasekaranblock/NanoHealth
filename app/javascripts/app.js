...
import token_artifacts from '../../build/contracts/NanoToken.json'
import Patient from '../../build/contracts/NanoPatient.json'

// MetaCoin is our usable abstraction, which we'll use through the code below.
var ExchangeContract = contract(exchange_artifacts);
var TokenContract = contract(token_artifacts);
var PatientContract = contract(Patient);
...
window.App = {
    start: function () {
        ...
        PatientContract.setProvider(web3.currentProvider);
...
// Add PATIENT
  ...
  addpatient: function(){
   ...
   var patientInstance;
    return PatientContract.deployed().then(function (instance) {
